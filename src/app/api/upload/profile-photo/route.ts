...
export async function DELETE(req: NextRequest) {
  try {
    ...
    if (site?.status !== "published") {
      ...
      console.log("Profile photo deleted permanently (site not published):", key);
      ...
      console.log("Profile photo marked for deletion (soft delete - site published):", key);
      ...
      return NextResponse.json({
        success: true,
        message: "Photo marked for deletion successfully",
      });
    }
  } catch (error) {
